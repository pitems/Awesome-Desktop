...
--original version ncmpcpp 
-- MPD
--[[local musicplr = awful.util.terminal .. " -title Music -g 130x34-320+16 -e ncmpcpp"]]--
local musicplr = awful.util.terminal2 .. " -title Music -g 130x34-320+16 -e ncmpcpp"
local mpdicon = wibox.widget.imagebox(theme.widget_music)
mpdicon:buttons(awful.util.table.join(
    awful.button({ altkey }, 1, function () awful.spawn.with_shell(musicplr) end),
...
function theme.at_screen_connect(s)
    ...
    s.mywiboxbottom = awful.wibar({ position = "bottom", screen = s, height = 16, bg = theme.bg_normal, fg = theme.fg_normal })
    ...
    s.mywiboxbottom:setup {
        ...
        { -- Left widgets
            layout = wibox.layout.fixed.horizontal,
            --spr,
              wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#a35f06"),
           arrow("#a35f06", "#343434"),     
             s.mytasklist,       
           -- wibox.widget.systray(),
